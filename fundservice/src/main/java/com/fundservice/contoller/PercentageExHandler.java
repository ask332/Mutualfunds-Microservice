...
public class PercentageExHandler {
	@RestControllerAdvice
	public class MutualFundExHandler {
		@ExceptionHandler(IncorrectDistributionException.class)
		public ResponseEntity<ErrorInfo> handle404(IncorrectDistributionException ex) {
